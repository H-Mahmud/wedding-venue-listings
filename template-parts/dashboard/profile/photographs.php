<form class="mt-14 profile-step-forms" id="profilePhotographsForm" data-step="5">
    <fieldset class="p-5 rounded-xl mb-8 border-gray-200">
        ...
        <label for="upload_cover" id="upload_cover_label" style="background-image: url('https://flowbite.s3.amazonaws.com/docs/gallery/square/image.jpg'); background-size: cover" class="cover-upload block text-center border  border-gray-200 rounded-lg hover:border-dashed hover:border-blue-600 cursor-pointer min-h-60 justify-center items-center">
