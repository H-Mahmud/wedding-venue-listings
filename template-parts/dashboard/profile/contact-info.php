<form class="mt-14 profile-step-forms" id="profileContactForm" data-step="3">
    ...
    <fieldset class="p-5 rounded-xl border-gray-200 mt-8 relative">
        <?php if (wvl_current_plan() == 'free'): ?>
            <div class="deemed absolute inset-0 flex items-center justify-center bg-black opacity-40 rounded-lg">
            </div>
            <div class=" absolute inset-0 flex items-center justify-center z-20">
                <h1 class="text-white font-semibold text-2xl""><?php _e('Upgrade to unlock this feature', 'wedding-venue-listings'); ?></h1>
            </div>
        <?php endif; ?>
