        ...
        <div class="review-item flex gap-8 mb-6 mt-3" id="comment-<?php echo $comment->comment_ID; ?>">
            ...
            <div class="flex-1">
                <div class="content bg-gray-100 p-4 rounded-lg">
                    <div class="meta flex flex-col md:flex-row gap-2 justify-between mb-2">
                    ...
                    <p><?php echo get_comment_text($comment); ?></p>
                        ...
                        if ($replies) {
                            foreach ($replies as $reply) { ?><div class="review-item flex gap-8 mt-6" id="comment-<?php echo $reply->comment_ID; ?>">
                            <div class="avatar w-20 h-20 max-w-20 rounded-lg border flex-1"><?php
                            ...
                            <div class="content flex-1 bg-gray-100 p-4 rounded-lg">
                                <div class="meta flex justify-between mb-2">
                                    <div class="info"><span class="name font-medium"><?php echo get_comment_author_link($reply->comment_ID); ?></span>- <span class="date"><?php echo get_comment_date('F j, Y', $reply->comment_ID); ?></span></div>
                                </div>
